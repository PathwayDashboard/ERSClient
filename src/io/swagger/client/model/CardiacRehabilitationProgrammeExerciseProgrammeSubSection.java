...
public class CardiacRehabilitationProgrammeExerciseProgrammeSubSection   {
  ...
  private Double hrrLowerThreshold = null;
   ...
   * hrrLowerThreshold
   **/
  @ApiModelProperty(value = "hrrLowerThreshold")
  @JsonProperty("hrrLowerThreshold")
  public Double getHrrLowerThreshold() {
    return hrrLowerThreshold;
  }
  public void setHrrLowerThreshold(Double hrrLowerThreshold) {
    this.hrrLowerThreshold = hrrLowerThreshold;
  }
  ...
  public String toString()  {
    ...
    sb.append("class CardiacRehabilitationProgrammeExerciseProgrammeSubSection {\n");
    ...
    sb.append("    hrrLowerThreshold: ").append(StringUtil.toIndentedString(hrrLowerThreshold)).append("\n");
