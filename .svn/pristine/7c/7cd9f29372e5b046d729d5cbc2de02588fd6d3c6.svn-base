...
public class CardiacRehabilitationProgressExerGameSessioncoolDownInfoSubSubsection   {
  
  private Integer duration = null;
  private Double averageHRBpm = null;
  private CardiacRehabilitationProgressExerGameSessionCoolDownInfohrRangeSubSubSubsection hrRange = null;
  ...
  public CardiacRehabilitationProgressExerGameSessionCoolDownInfohrRangeSubSubSubsection getHrRange() {
    return hrRange;
  }
  public void setHrRange(CardiacRehabilitationProgressExerGameSessionCoolDownInfohrRangeSubSubSubsection hrRange) {
  ...
  public String toString()  {
    ...
    sb.append("class CardiacRehabilitationProgressExerGameSessioncoolDownInfoSubSubsection {\n");
