...
public class CardiacRehabilitationProgressExerClassSessionCoolDownInfohrRangeSubSubSubsection   {
  ...
  public String toString()  {
    ...
    sb.append("class CardiacRehabilitationProgressExerClassSessionCoolDownInfohrRangeSubSubSubsection {\n");
