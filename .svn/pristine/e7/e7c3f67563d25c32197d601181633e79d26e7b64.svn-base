...
public class CardiacRehabilitationProgressExerGameSessionPreScreeningInforestingBloodPressureSubSubSubsection   {
  ...
  public String toString()  {
    ...
    sb.append("class CardiacRehabilitationProgressExerGameSessionPreScreeningInforestingBloodPressureSubSubSubsection {\n");
